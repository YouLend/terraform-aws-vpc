...
| [aws_route_table.ftp](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table) | resource |
...
| [aws_subnet.ftp](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
...
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | AWS region where the VPC will be created | `string` | `"eu-west-1"` | no |
...
| <a name="input_eks_subnets"></a> [eks\_subnets](#input\_eks\_subnets) | Map of EKS subnets attributes. The key is the subnet name, and the value is a map with attributes like az, cidr\_block, and tags. | `map(map(any))` | n/a | yes |
...
| <a name="input_ftp_route_table_tags"></a> [ftp\_route\_table\_tags](#input\_ftp\_route\_table\_tags) | Additional tags for the ftp route tables | `map(string)` | `{}` | no |
| <a name="input_ftp_subnet_assign_ipv6_address_on_creation"></a> [ftp\_subnet\_assign\_ipv6\_address\_on\_creation](#input\_ftp\_subnet\_assign\_ipv6\_address\_on\_creation) | Assign IPv6 address on ftp subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map\_public\_ip\_on\_launch | `bool` | `null` | no |
| <a name="input_ftp_subnet_ipv6_prefixes"></a> [ftp\_subnet\_ipv6\_prefixes](#input\_ftp\_subnet\_ipv6\_prefixes) | Assigns IPv6 ftp subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list | `list(string)` | `[]` | no |
| <a name="input_ftp_subnet_suffix"></a> [ftp\_subnet\_suffix](#input\_ftp\_subnet\_suffix) | Suffix to append to ftp subnets name | `string` | `"ftp"` | no |
| <a name="input_ftp_subnet_tags"></a> [ftp\_subnet\_tags](#input\_ftp\_subnet\_tags) | Additional tags for the private subnets | `map(string)` | `{}` | no |
| <a name="input_ftp_subnets"></a> [ftp\_subnets](#input\_ftp\_subnets) | A list of private subnets inside the VPC | `list(string)` | `[]` | no |
...
| <a name="input_stage"></a> [stage](#input\_stage) | Stage of the environment, e.g. dev, staging, prod | `string` | `"dev"` | no |
